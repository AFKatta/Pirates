function PlayerCollision() {
	...
	//Horizontal Tiles
	if (tilemap_get_at_pixel(collisionMap, x + sign(hSpeed) + hSpeed, y))
	{
		x -= x mod TILE_SIZE;
	...
	var _entityCount = instance_position_list(x, temp + vSpeed, par_Entity, _entityList, false);
	var _snapY;
	while (_entityCount > 0)
	{
		var _entityCheck = _entityList[| 0];
